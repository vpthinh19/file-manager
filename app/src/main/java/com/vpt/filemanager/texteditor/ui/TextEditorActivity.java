...
import com.vpt.filemanager.core.error.ErrorPresenter;
import com.vpt.filemanager.texteditor.document.DocumentService;
import com.vpt.filemanager.texteditor.document.DocumentSession;
...
public final class TextEditorActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_DISPLAY_NAME = "com.vpt.filemanager.extra.DISPLAY_NAME";
    public static final String EXTRA_READ_ONLY = "com.vpt.filemanager.extra.READ_ONLY";
    public static final String EXTRA_ARCHIVE_ENTRY = "com.vpt.filemanager.extra.ARCHIVE_ENTRY";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        forcedReadOnly = getIntent().getBooleanExtra(EXTRA_READ_ONLY, false);
        String serializedArchiveEntry = getIntent().getStringExtra(EXTRA_ARCHIVE_ENTRY);
        archiveEntry = serializedArchiveEntry == null ? null : Path.deserialize(serializedArchiveEntry);
    ...
    private void startLoad() {
        ...
        executors.io().execute(() -> {
            ...
            } catch (FileOperationException | SecurityException error) {
    ...
    private void applyDocument(DocumentSession.LoadResult result) {
        ...
        try {
            ...
            documentLoaded = true;
            writable = result.writable && !forcedReadOnly;
            modified = false;
