 ...
 *
 * <p>Package-private + singleton — chỉ {@link VirtualNode#parent(NodePath)} factory tạo node
 * dùng source này. Detect qua {@code instanceof ParentSource} trong {@link VirtualNode}.
 */
public final class ParentSource implements NodeSource {
    public static final ParentSource INSTANCE = new ParentSource();
