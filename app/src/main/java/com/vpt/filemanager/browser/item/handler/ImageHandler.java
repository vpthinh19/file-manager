...
public final class ImageHandler implements ItemHandler {
    private final ArchiveRepository archives;
    @Inject public ImageHandler(ArchiveRepository archives) { this.archives = archives; }
    ...
    public ActionResult activate(PaneId pane, Item item) throws FileOperationException {
        ...
        return new ActionResult.Effect(new WorkspaceEffect.OpenImage(path));
    }
}
