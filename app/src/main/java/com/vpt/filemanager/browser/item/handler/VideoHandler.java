...
public final class VideoHandler implements ItemHandler {
    private final ArchiveRepository archives;
    @Inject public VideoHandler(ArchiveRepository archives) { this.archives = archives; }
    ...
    public ActionResult activate(PaneId pane, Item item) throws FileOperationException {
        ...
        return new ActionResult.Effect(new WorkspaceEffect.OpenMedia(path, true));
    }
}
