...
public final class ContentHostComponent {
    ...
    private static final long ENTER_TRANSITION_MILLIS = 450L;
    private static final long EXIT_TRANSITION_MILLIS = 400L;
    private static final float CONTENT_ENTER_SCALE = 0.92f;
    private static final float BROWSER_EXIT_SCALE = 0.95f;
        ...
        if (reveal) {
            host.getViewTreeObserver().addOnPreDrawListener(new android.view.ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    if (content.equals(shown) && host.getVisibility() == View.VISIBLE) {
                        revealContent();
                    }
                    return true;
                }
    ...
    private void revealContent() {
        ...
        host.animate()
                ...
                .setDuration(ENTER_TRANSITION_MILLIS)
                .setInterpolator(ENTER_EASING)
                .withLayer()
                .start();

        browser.animate()
                .alpha(0f).scaleX(BROWSER_EXIT_SCALE).scaleY(BROWSER_EXIT_SCALE)
                .setDuration(ENTER_TRANSITION_MILLIS)
                .setInterpolator(ENTER_EASING)
                .withLayer()
                .withEndAction(() -> {
    ...
    private void hideContent() {
        ...
        browser.animate()
                .alpha(1f).scaleX(1f).scaleY(1f)
                .setDuration(EXIT_TRANSITION_MILLIS)
                .setInterpolator(EXIT_EASING)
                .withLayer()
                .start();

        host.animate()
                .alpha(0f).scaleX(CONTENT_ENTER_SCALE).scaleY(CONTENT_ENTER_SCALE)
                .setDuration(EXIT_TRANSITION_MILLIS)
                .setInterpolator(EXIT_EASING)
                .withLayer()
                .withEndAction(() -> {
