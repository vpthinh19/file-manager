 ...
 *   - {@code NodeOpener.decide} → which viewer Action (text editor / image / archive / open with)
 ...
 * touching this enum + colors.xml + FileLabel + NodeOpener (compile-time check via switch).
 */
